...
| --- | --- | --- | --- |
| `discover` (default) | `drive → triage → lift → terminal{closed}` | Goal-directed reverse engineering — drive the UI, hand off to triage to read the defense surface, lift via the RE playbook, save a strategy. |
