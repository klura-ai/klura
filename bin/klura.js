...
const COMMANDS = {
  ...
  [CLI_COMMAND_NAMES.stopListener]: describeTool(TOOL_NAMES.stopListener),
  [CLI_COMMAND_NAMES.getEvents]: describeTool(TOOL_NAMES.getEvents),
  [CLI_COMMAND_NAMES.hookEvents]: 'Claude Code hook helper — drain queue into hook JSON',
  [CLI_COMMAND_NAMES.patchStep]: describeTool(TOOL_NAMES.patchStep),
  [CLI_COMMAND_NAMES.markHealed]: 'Mark a strategy as healed after patching',
  [CLI_COMMAND_NAMES.resume]: describeTool(TOOL_NAMES.resume),
  [CLI_COMMAND_NAMES.history]: 'Show mutation history for a platform',
  [CLI_COMMAND_NAMES.device]:
    "Manage this daemon's device profile (optional; default desktop preset accepts mouse+touch)",
  [CLI_COMMAND_NAMES.policy]: 'Manage per-platform policy (show/set/clear)',
  [CLI_COMMAND_NAMES.identity]: 'Manage per-platform identities (show/set/list/clear)',
  [CLI_COMMAND_NAMES.secret]: 'Manage secret resolvers (add/list/remove)',
  [CLI_COMMAND_NAMES.list]: 'List discovered skills',
  [CLI_COMMAND_NAMES.liftRate]: 'Report LIFT rate — how many skills skip the browser',
  [CLI_COMMAND_NAMES.status]: 'Show daemon status',
  [CLI_COMMAND_NAMES.daemon]: 'Manage daemon (start/stop/status)',
  [CLI_COMMAND_NAMES.warmup]: 'Pre-warm DNS/TLS/browser caches (internal dev use)',
};
