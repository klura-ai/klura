...
// String-distance helpers (Levenshtein + did-you-mean) live in
// runtime/src/utils/string-distance.ts. Re-exported here so existing call
// sites that imported these from '../validators' keep working — and so
// callers can discover them by name during the rejection-composition flow.
export {
  closestAllowed,
  closestAllowedCandidates,
  didYouMeanSuffix,
  formatCandidateList,
} from '../utils/string-distance';
